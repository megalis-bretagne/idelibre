 ...
 */
final class Version20201004172550 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE email_template (id UUID NOT NULL, structure_id UUID NOT NULL, type_id UUID DEFAULT NULL, name VARCHAR(255) NOT NULL, content TEXT NOT NULL, subject VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
