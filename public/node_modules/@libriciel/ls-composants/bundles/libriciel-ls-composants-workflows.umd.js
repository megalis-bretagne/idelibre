(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser/animations'), require('@angular/forms'), require('@angular/common'), require('@angular/platform-browser'), require('@ng-bootstrap/ng-bootstrap'), require('@angular/cdk/drag-drop'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@libriciel/ls-composants/workflows', ['exports', '@angular/platform-browser/animations', '@angular/forms', '@angular/common', '@angular/platform-browser', '@ng-bootstrap/ng-bootstrap', '@angular/cdk/drag-drop', '@angular/core'], factory) :
    (factory((global.libriciel = global.libriciel || {}, global.libriciel['ls-composants'] = global.libriciel['ls-composants'] || {}, global.libriciel['ls-composants'].workflows = {}),global.ng.platformBrowser.animations,global.ng.forms,global.ng.common,global.ng.platformBrowser,global.ngBootstrap,global.ng.cdk['drag-drop'],global.ng.core));
}(this, (function (exports,animations,forms,common,platformBrowser,ngBootstrap,dragDrop,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.ɵa = LsWorkflowEditorComponent;
    exports.ɵc = LsWorkflowInstanceViewerComponent;
    exports.ɵb = LsWorkflowModelViewerComponent;
