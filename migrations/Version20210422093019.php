 ...
 */
final class Version20210422093019 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annotation_user DROP CONSTRAINT annotation_user_pkey');
        $this->addSql('ALTER TABLE annotation_user ADD id UUID NOT NULL');
        $this->addSql('ALTER TABLE annotation_user ADD is_read BOOLEAN DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE annotation_user ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annotation_user DROP CONSTRAINT fk_8e2206cde075fc54');
        $this->addSql('ALTER TABLE annotation_user DROP CONSTRAINT fk_8e2206cda76ed395');
        $this->addSql('DROP INDEX annotation_user_pkey');
        $this->addSql('ALTER TABLE annotation_user DROP id');
        $this->addSql('ALTER TABLE annotation_user DROP is_read');
        ...
        $this->addSql('ALTER TABLE annotation_user ADD PRIMARY KEY (annotation_id, user_id)');
    }
}
