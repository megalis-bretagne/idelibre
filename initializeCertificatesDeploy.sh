...
if [ ! -f "$FILE" ] || [ $force = true ]; then
  ...
  sed -i -e"s|TAG|$VERSION|" docker-compose.yml
fi
...
echo "### Starting nginx ..."
docker compose -f docker-compose.yml up --force-recreate -d nginx-idelibre
echo
...
docker compose -f docker-compose.yml exec nginx-idelibre nginx -s reload
