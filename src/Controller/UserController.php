...
class UserController extends AbstractController
{
    ...
    #[Breadcrumb(title: 'Modification de l\'utilisateur {user.firstName} {user.lastName}')]
    ...
    public function preferences(Request $request, UserManager $userManager, UserLoginEntropy $userLoginEntropy): Response
    {
        ...
        return $this->render('user/preferences.html.twig', [
            ...
            'subscriptionResponse' => $user->getSubscription() ? $user->getSubscription()->getAcceptMailRecap() : false,
        ]);
    }
