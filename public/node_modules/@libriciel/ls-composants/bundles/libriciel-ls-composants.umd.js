(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('@angular/common'), require('@angular/common/http'), require('rxjs'), require('@angular/platform-browser/animations'), require('@angular/forms'), require('@angular/core'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('@libriciel/ls-composants', ['exports', '@angular/animations', '@angular/common', '@angular/common/http', 'rxjs', '@angular/platform-browser/animations', '@angular/forms', '@angular/core', '@angular/platform-browser'], factory) :
    (factory((global.libriciel = global.libriciel || {}, global.libriciel['ls-composants'] = {}),global.ng.animations,global.ng.common,global.ng.common.http,global.rxjs,global.ng.platformBrowser.animations,global.ng.forms,global.ng.core,global.ng.platformBrowser));
}(this, (function (exports,animations,common,http,rxjs,animations$1,forms,core,platformBrowser) { 'use strict';
    ...
    var BackToTopComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        BackToTopComponent.prototype.checkScroll = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        BackToTopComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.checkScroll();
         ...
         * @return {?}
         */
        BackToTopComponent.prototype.backToTop = /**
         * @return {?}
         */
            function () {
        ...
        BackToTopComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        styles: ["div.backtotop{position:fixed;z-index:9999;bottom:45px;right:20px;cursor:pointer}div.backtotop .top-link{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;text-decoration:none;text-align:center;color:#fff;font-size:2em;width:50px;height:50px;line-height:50px;border-radius:5px;background:#000;opacity:.7}"]
                    }] }
        ];
    ...
    var MaxLengthTextAreaMessages = /** @class */ (function () {
         ...
         * @return {?}
         */
        MaxLengthTextAreaMessages.max_left = /**
         * @param {?} size
         * @return {?}
         */
            function (size) {
    ...
    var MaxLengthTextAreaComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        MaxLengthTextAreaComponent.prototype.ngAfterViewInit = /**
         * @return {?}
         */
            function () {
                /** @type {?} */
         ...
         * @return {?}
         */
        MaxLengthTextAreaComponent.prototype.onChangeSelection = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        MaxLengthTextAreaComponent.prototype.registerOnChange = /**
         * @param {?} fn
         * @return {?}
         */
            function (fn) {
         ...
         * @return {?}
         */
        MaxLengthTextAreaComponent.prototype.registerOnTouched = /**
         * @param {?} fn
         * @return {?}
         */
            function (fn) {
         ...
         * @return {?}
         */
        MaxLengthTextAreaComponent.prototype.writeValue = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
        ...
        /** @nocollapse */
        MaxLengthTextAreaComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: core.Renderer2 }
            ];
    ...
    ***************************************************************************** */
    ...
    var LibersignStatus = /** @class */ (function () {
         ...
         * @return {?}
         */
        LibersignStatus.prototype.isLoading = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        LibersignStatus.prototype.showCerts = /**
         * @return {?}
         */
            function () {
    ...
    var LibersignComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        LibersignComponent.ctorParameters = function () {
            return [
    ...
    var SidebarService = /** @class */ (function () {
         ...
         * @return {?}
         */
        SidebarService.prototype.collapsed = /**
         * @param {?} isCollapsed
         * @return {?}
         */
            ...
            function () {
                ...
                try {
                    for (var mainMenu_1 = __values(mainMenu), mainMenu_1_1 = mainMenu_1.next(); !mainMenu_1_1.done; mainMenu_1_1 = mainMenu_1.next()) {
                        ...
                        var _loop_2 = function (child) {
                             ...
                             */function () {
                                ...
                                try {
                                    ...
                                    try {
                                        if (activeItems_1_1 && !activeItems_1_1.done && (_a = activeItems_1.return))
                                            _a.call(activeItems_1);
                                    }
                                    finally {
                                        if (e_4)
                                            throw e_4.error;
                        ...
                        var this_2 = this;
                        try {
                            for (var _c = __values(menu.children), _d = _c.next(); !_d.done; _d = _c.next()) {
                                var child = _d.value;
                                _loop_2(child);
                            }
                        }
                    ...
                    try {
                        if (mainMenu_1_1 && !mainMenu_1_1.done && (_a = mainMenu_1.return))
                            _a.call(mainMenu_1);
                    }
                    finally {
                        if (e_2)
            ...
            function () {
                ...
                var _loop_3 = function (submenu) {
                     ...
                     */function () {
                        ...
                        try {
                            // We remove all active class
                            for (var subMenus_2 = __values(subMenus), subMenus_2_1 = subMenus_2.next(); !subMenus_2_1.done; subMenus_2_1 = subMenus_2.next()) {
                            ...
                            try {
                                if (subMenus_2_1 && !subMenus_2_1.done && (_a = subMenus_2.return))
                                    _a.call(subMenus_2);
                            }
                            finally {
                                if (e_6)
                ...
                try {
                    ...
                    try {
                        if (subMenus_1_1 && !subMenus_1_1.done && (_a = subMenus_1.return))
                            _a.call(subMenus_1);
                    }
                    finally {
                        if (e_5)
    ...
    var ContentComponent = /** @class */ (function () {
         ...
         * @param {?} isCollapsed
         * @return {?}
         */function (isCollapsed) { return _this.collapseEvent(isCollapsed); }));
        }
        /**
         * @return {?}
         */
         ...
         * @return {?}
         */
        ContentComponent.prototype.collapseEvent = /**
         * @param {?} isCollapsed
         * @return {?}
         */
            function (isCollapsed) {
        ...
        ContentComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        styles: [":host.sidebar-collapsed main{padding-left:7rem}:host:not(.sidebar-collapsed) main{padding-left:16rem}:host main{min-height:calc(100vh - 1.9rem);padding-right:4rem;padding-top:3.5rem;padding-bottom:3rem;-webkit-transition:padding-left .3s;transition:padding-left .3s}@media only screen and (max-width:768px){:host:not(.sidebar-collapsed) main{padding-left:4rem}:host.sidebar-collapsed main{padding-left:4rem}:host main{padding-right:.5rem}}"]
                    }] }
        ];
        /** @nocollapse */
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/pages/login/login-config/login-config.model.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/pages/login/login-model/LoginPageModel.class.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var LoginPageModelClass = /** @class */ (function () {
         ...
         * @return {?}
         */
        LoginPageModelClass.prototype.preventFormSubmit = /**
         * @param {?} event
         * @return {?}
         */
            function (event) {
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/pages/login/forgot-password-success/forgot-password-success.component.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ForgotPasswordSuccessComponent = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        ForgotPasswordSuccessComponent.prototype.backToLoginPage = /**
         * @return {?}
         */
            function () {
                this.backToLogin.emit();
        ...
        ForgotPasswordSuccessComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<ls-login-model [logo]=\"logo\" [visualConfiguration]=\"_visualConfiguration\">\n  <section class=\"forgot-success-page\">\n\n    <div class=\"alert alert-success\">\n      <i class=\"fa fa-lg fa-check\"></i>\n      Si vos informations sont correctes, un e-mail vous a \u00E9t\u00E9 envoy\u00E9.\n    </div>\n    <button (click)=\"backToLoginPage()\" class=\"btn btn-primary\">Retourner \u00E0 la page de connexion</button>\n  </section>\n</ls-login-model>\n",
                        styles: [".alert{margin-top:2rem;padding:1.5rem;text-align:center;width:600px}.forgot-success-page{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.forgot-success-page>*{margin-bottom:2rem}"]
                    }] }
        ];
        /** @nocollapse */
        ForgotPasswordSuccessComponent.ctorParameters = function () {
            return [
                { type: platformBrowser.DomSanitizer }
            ];
        };
    ...
    var LoginConfigComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        LoginConfigComponent.prototype.onSaved = /**
         * @return {?}
         */
            function () {
                var _this = this;
         ...
         * @return {?}
         */
        LoginConfigComponent.prototype.stopPropagation = /**
         * @param {?} event
         * @return {?}
         */
            function (event) {
         ...
         * @return {?}
         */
        LoginConfigComponent.prototype.onEscapeKeyPressed = /**
         * @return {?}
         */
            function () {
                this.showPrevisu = false;
         ...
         * @return {?}
         */
        LoginConfigComponent.prototype.onFileChanged = /**
         * @param {?} event
         * @return {?}
         */
            function (event) {
         ...
         * @return {?}
         */
        LoginConfigComponent.prototype.removeCurrentFile = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        LoginConfigComponent.prototype.onReset = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        LoginConfigComponent.prototype.onSave = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        LoginConfigComponent.prototype.onBack = /**
         * @return {?}
         */
            function () {
                this.back.emit();
        ...
        /** @nocollapse */
        LoginConfigComponent.ctorParameters = function () {
            return [
                { type: platformBrowser.DomSanitizer }
            ];
        };
    ...
    var ResetPasswordComponent = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        ResetPasswordComponent.prototype.preventFormSubmit = /**
         * @param {?} event
         * @return {?}
         */
            function (event) {
         ...
         * @return {?}
         */
        ResetPasswordComponent.prototype.submitForm = /**
         * @return {?}
         */
            function () {
        ...
        ResetPasswordComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        styles: ["span.btn{cursor:pointer}#reset-form .alert-soft-warning{text-align:center}.page-title{font-size:1rem;font-weight:400;padding-top:3rem;padding-bottom:1.5rem;text-align:center}.login-input-row{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.login-input-row>label{width:33%;margin-right:1rem}.login-input-row>div{display:inline-block;width:67%}.login-input-row>.form-check{width:100%;padding-left:calc(33% + 35px)}.floating-message{left:10%;right:10%;top:5%;position:absolute}.floating-message div{-webkit-box-align:center;-ms-flex-align:center;align-items:center;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;min-height:4rem}.floating-message div i{padding-right:20px}.ls-login-footer{height:40px;width:100%}"]
                    }] }
        ];
        /** @nocollapse */
    ...
    var LoginModelComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        LoginModelComponent.prototype.getImageDimensions = /**
         * @param {?} file
         * @return {?}
         */
            function (file) {
         ...
         * @return {?}
         */
        LoginModelComponent.prototype.handleImgPositionning = /**
         * @return {?}
         */
            function () {
        ...
        /** @nocollapse */
        LoginModelComponent.ctorParameters = function () {
            return [
                { type: platformBrowser.DomSanitizer }
            ];
        };
    ...
    exports.ɵl = BackToTopComponent;
    exports.ɵm = ColorPickerComponent;
    exports.ɵq = LibersignComponent;
    exports.ɵn = MaxLengthTextAreaComponent;
    exports.ɵo = PasswordComponent;
    exports.ɵp = TimepickerComponent;
    exports.ɵk = LsUiComponentsModule;
    exports.ɵh = ForgotPasswordSuccessComponent;
    exports.ɵg = ForgotPasswordComponent;
    exports.ɵd = LoginConfigComponent;
    exports.ɵe = LoginFormComponent;
    exports.ɵf = LoginPageModelClass;
    exports.ɵc = LoginModelComponent;
    exports.ɵb = LsLoginModule;
    exports.ɵj = LoginComponent;
    exports.ɵi = ResetPasswordComponent;
    exports.ɵa = LsPagesModule;
    exports.ɵs = FooterComponent;
    exports.ɵr = LsStructureModule;
