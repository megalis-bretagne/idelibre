...
export declare class LsWorkflowEditorComponent implements OnInit {
    ...
    constructor();
    get localizedMessages(): WorkflowModelLocalizedMessages;
    set localizedMessages(value: WorkflowModelLocalizedMessages);
    get options(): WorkflowModelOptions;
    set options(value: WorkflowModelOptions);
    get workflow(): WorkflowModel;
    set workflow(newValue: WorkflowModel);
    ngOnInit(): void;
